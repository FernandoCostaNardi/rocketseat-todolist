package com.sysconard.Glojas.repository.helper.usuario;
...
import com.sysconard.Glojas.model.UsuarioGrupo;
...
public class UsuariosImpl implements UsuariosQueries {
	...
	@Override
	public String buscarBancoDoCliente(String email) {
		Optional<Usuario> usuario = usuarios.findByEmail(email);
		String banco = usuario.get().getBanco();
		return banco;
	}
}

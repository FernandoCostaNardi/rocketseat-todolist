...
@Controller
@RequestMapping("/vendas/{tenantid}/margemContribuicaoSubGrupoPorPeriodo_{tenantid}")
public class VendasMargemContribuicaoSubGrupo_jabController {
	...
	public ModelAndView pesquisar(@PathVariable String tenantid) {
		...
		ModelAndView mv = new ModelAndView("/vendas" + "/" + tenantid + "/margemContribuicaoSubGrupoPorPeriodo_"  + tenantid);
	...
	public ModelAndView pesquisarEntreDatas(@PathVariable String tenantid,
		...
		ModelAndView mv = new ModelAndView("/vendas" + "/" + tenantid + "/margemContribuicaoSubGrupoPorPeriodo_"  + tenantid);
		mv.addObject("margemContribucaoSubGrupoPorPeriodo", documentos.SomaContribuicaoSubGrupoPorPeriodo_jab(dataEmissaoInicial, dataEmissaoFinal));
